...
public class Tripcasestudy extends Javascript_utill {
public static String url="https://www.makemytrip.com/";
	...
	ele.click();
	Javascript_utill.scrollIntoView(ele, driver);
	Thread.sleep(6000);
	...
	ele2.click();
	Javascript_utill.scrollIntoView(ele2, driver);
	Thread.sleep(6000);
	
	WebElement ele3=driver.findElement(By.xpath("//*[@class='sidePanelBody']/div[2]/div[2]/div[3]/span"));
	ele3.click();
	Javascript_utill.scrollIntoView(ele3, driver);
	Thread.sleep(8000);
